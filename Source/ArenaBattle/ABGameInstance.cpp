...
{
	Super::Init();
	ABLOG(Warning, TEXT("MaxHP of Level 20 ABCharacter : %d"), GetABCharacterData(20)->MaxHP);
	ABLOG(Warning, TEXT("DropExp of Level 20 ABCharacter : %d"), GetABCharacterData(20)->DropExp);
	ABLOG(Warning, TEXT("NextExp of Level 20 ABCharacter : %d"), GetABCharacterData(20)->NextExp);
}
